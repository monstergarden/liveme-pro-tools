...
namespace LMPT.DB.Migrations
{
    ...
    [Migration("20190408163059_AddScanResult")]
    partial class AddScanResult
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMPT.DB.ScanResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("LMPT.DB.ScanResult", b =>
                {
                    b.HasOne("LMPT.Core.Contract.Models.Bookmark.Bookmark", "Bookmark")
                        .WithMany()
