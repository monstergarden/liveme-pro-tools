...
namespace LMPT.Core.Services
{
    ...
    {
        private static readonly List<(string, string)> _countryCodes = new List<(string, string)>
        {
            ("All Countries", "-"), ("Afghanistan", "AF"), ("Albania", "AL"), ("Algeria", "DZ"),
            ...
            ("Benin", "BJ"),
            ("Bermuda", "BM"), ("Bhutan", "BT"), ("Bolivia", "BO"), ("Bosnia-Herzegovina", "BA"), ("Botswana", "BW"),
            ("Bouvet Island", "BV"),
            ...
            ("Comoros", "KM"), ("Congo", "CG"), ("Congo, Dem. Republic", "CD"), ("Cook Islands", "CK"),
            ("Costa Rica", "CR"), ("Croatia", "HR"),
            ("Cuba", "CU"), ("Cyprus", "CY"), ("Czech Rep.", "CZ"), ("Denmark", "DK"), ("Djibouti", "DJ"),
            ("Dominica", "DM"),
            ("Dominican Republic", "DO"), ("Ecuador", "EC"), ("Egypt", "EG"), ("El Salvador", "SV"),
            ("Equatorial Guinea", "GQ"), ("Eritrea", "ER"),
            ("Estonia", "EE"), ("Ethiopia", "ET"), ("European Union", "EU.INT"), ("Falkland Islands (Malvinas)", "FK"),
            ("Faroe Islands", "FO"), ("Fiji", "FJ"),
            ("Finland", "FI"), ("France", "FR"), ("French Guiana", "GF"), ("French Southern Territories", "TF"),
            ("Gabon", "GA"), ("Gambia", "GM"),
            ("Georgia", "GE"), ("Germany", "DE"), ("Ghana", "GH"), ("Gibraltar", "GI"), ("Great Britain", "GB"),
            ("Greece", "GR"),
            ("Greenland", "GL"), ("Grenada", "GD"), ("Guadeloupe (French)", "GP"), ("Guam (USA)", "GU"),
            ...
            ("Marshall Islands", "MH"),
            ("Martinique (French)", "MQ"), ("Mauritania", "MR"), ("Mauritius", "MU"), ("Mayotte", "YT"),
            ...
            ("Netherlands", "NL"),
            ("Netherlands Antilles", "AN"), ("New Caledonia (French)", "NC"), ("New Zealand", "NZ"),
            ...
            ("Reunion (French)", "RE"), ("Romania", "RO"), ("Russia", "RU"), ("Rwanda", "RW"), ("Saint Helena", "SH"),
            ("Saint Kitts and Nevis Anguilla", "KN"),
            ("Saint Lucia", "LC"), ("Saint Pierre and Miquelon", "PM"), ("Saint Vincent and Grenadines", "VC"),
            ("Samoa", "WS"), ("San Marino", "SM"), ("Sao Tome and Principe", "ST"),
            ("Saudi Arabia", "SA"), ("Senegal", "SN"), ("Serbia", "RS"), ("Seychelles", "SC"), ("Sierra Leone", "SL"),
            ("Singapore", "SG"),
            ("Slovakia", "SK"), ("Slovenia", "SI"), ("Solomon Islands", "SB"), ("Somalia", "SO"),
            ("South Africa", "ZA"), ("South Georgia and South Sandwich Islands", "GS"),
            ...
            ("Tuvalu", "TV"), ("U.K.", "UK"),
            ("USA", "US"), ("USA Minor Outlying Islands", "UM"), ("Uganda", "UG"), ("Ukraine", "UA"),
            ("United Arab Emirates", "AE"), ("Uruguay", "UY"),
        ...
        private static readonly Dictionary<string, string> _dict =
            _countryCodes.ToDictionary(x => x.Item2, x => x.Item1);

        public static string GetFullName(string abbr)
        {
            return _dict.TryGetValue(abbr.ToUpper(), out var res) ? res : "unkown";
        }
    }
}